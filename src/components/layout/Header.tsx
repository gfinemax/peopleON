...
export function Header({ title = '통합 대시보드', iconName, leftContent, rightContent, userEmail, userName }: HeaderProps) {
    ...
    return (
        <header className="sticky top-0 z-10 flex h-auto min-h-14 w-full items-center justify-between border-b border-border bg-background/95 px-4 pt-[calc(env(safe-area-inset-top)+5px)] pb-1.5 backdrop-blur-xl md:pt-0 md:pb-0 md:h-14">
            ...
            <div className="flex items-center gap-2">
                ...
                {/* Notifications */}
                <button className="relative flex h-8 w-8 items-center justify-center rounded-md border border-border/60 bg-secondary/50 text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground">
                ...
                <div className="flex items-center gap-1 pl-0.5 ml-0 border-l border-border/50">
                    ...
                    <div className="hidden md:flex size-8 rounded-full bg-primary/10 border border-primary/25 items-center justify-center">
