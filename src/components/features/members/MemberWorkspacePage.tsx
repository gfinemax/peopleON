...
const memberTerm = (input?: string | null) => (input || '-')
    .replaceAll('비조합원권리증', '비조합원 가입신청필증')
    .replaceAll('권리증보유자', '가입신청필증 보유자')
    .replaceAll('권리증환불', '가입신청필증 환불')
    .replaceAll('권리증번호', '필증번호')
    .replaceAll('권리증', '가입신청필증');
