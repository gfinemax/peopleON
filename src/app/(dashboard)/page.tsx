            ...
            <main className="flex flex-1 flex-col overflow-y-auto">
                <div className="flex flex-col gap-6 p-6 lg:p-8 max-w-[1600px] mx-auto w-full">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="group flex flex-col rounded-2xl border border-border bg-card p-8 shadow-sm hover:shadow-xl hover:border-border/80 transition-all duration-300">
                        ...
                        <div className="group flex flex-col rounded-xl border border-border bg-card p-6 shadow-sm hover:shadow-xl hover:border-border/80 transition-all duration-300">
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
                        {/* Table (8/12 col span) */}
                        <div className="flex flex-col rounded-2xl border border-border bg-card shadow-sm lg:col-span-8 overflow-hidden">
                        ...
                        <div className="flex flex-col rounded-xl border border-border bg-card shadow-sm lg:col-span-4 h-fit">
    ...
    return (
        <div className="relative flex gap-4">
            ...
            <div className="flex flex-col items-center flex-shrink-0">
                <div className={cn("flex h-9 w-9 items-center justify-center rounded-xl border border-border/50 z-10 shadow-sm", iconBg, iconColor)}>
